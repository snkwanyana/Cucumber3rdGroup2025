...
Feature: Sign up screen for the user to create login details
  ...
  Scenario Outline: As a user, I want to sign up to get access to Ndosi automation platform
    ...
    And User selects group <grooupName>
    ...
    Examples:
      ...
      | Castle | Jaguar   | Lafae@gmail.com | Password@123 | Password@123    | 1st Group 2026(2026) | Registration successful! You can now login with your credentials. |
